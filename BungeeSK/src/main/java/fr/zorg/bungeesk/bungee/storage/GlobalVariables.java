 ...
 * Redis calls are fail-safe — on any error they log and behave as if the value is absent, so a Redis
 * outage never propagates an exception into the packet handlers.
 */
