...
public class EffExecuteCommand extends Effect {
    ...
    static {
        Syntax.effect(EffExecuteCommand.class, EffExecuteCommand::new,
    ...
    protected void execute(Event e) {
        ...
        switch (this.pattern) {
            ...
            case 1: {
                if (this.server.getSingle(e) == null)
                    return;
                toSend = this.server.getSingle(e);
                break;
            }
            case 2:
                toSend = "all";
        ...
        final MakeServerExecuteCommandPacket packet = new MakeServerExecuteCommandPacket(toSend, this.command.getSingle(e));
